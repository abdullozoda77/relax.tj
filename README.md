...
Для Парка Рудаки команда также добавляет описание и 5 фото из `places/seed_photos/`
...
- `/places/<id>` — страница места: фото, показатели, 3D-вид местности (MapLibre GL:
  спутниковые снимки Esri на реальном рельефе AWS Terrain Tiles, без API-ключа), карта и высота, подробности,
